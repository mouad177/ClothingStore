...
import product24 from '/MyLandingPageProjects/ClothingStore/src/assets/Caps/black-cap-front-view-isolated.png'
import product25 from '/MyLandingPageProjects/ClothingStore/src/assets/Caps/black-yellow-cap-headwear-accessory.png'
import product26 from '/MyLandingPageProjects/ClothingStore/src/assets/Caps/isolated-white-cap.png'
import product27 from '/MyLandingPageProjects/ClothingStore/src/assets/Caps/vector-realistic-white-baseball-cap-side-view-isolated-background.png'
import product28 from '/MyLandingPageProjects/ClothingStore/src/assets/Caps/black-sport-visor-cotton-object.png'
...
<div id="pr">
<Link  to='/product9' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
  <img width={200} src={product9} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product24' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
  <img width={200} src={product24} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product25' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
  <img width={200} src={product25} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product26' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product26} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product27' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product27} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product28' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product28} />
<div className="flex items-center  flex-col  space-y-3">
...
<div id="pr" >
<Link  to='/product9' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
  <img width={200} src={product9} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product24' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
  <img width={200} src={product24} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product25' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
  <img width={200} src={product25} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product26' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product26} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product27' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product27} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product28' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product28} />
<div className="flex items-center  flex-col  space-y-3">
