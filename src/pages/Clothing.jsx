...
<div id="pr">
<Link  to='/product4' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
  <img width={200} src={product4} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product5' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
  <img width={200} src={product5} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product7' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
  <img width={200} src={product7} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product10' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product10} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product2' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product2} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product13' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product13} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product14' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product14} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product15' className="md:hidden flex flex-col justify-center items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product15} />
<div className="flex items-center flex-col  space-y-3">
...
<div id="pr" >
<Link  to='/product4' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
  <img width={200} src={product4} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product5' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
  <img width={200} src={product5} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product7' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
  <img width={200} src={product7} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product10' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product10} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product2' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product2} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product13' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product13} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product14' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product14} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product15' className="hidden md:flex flex-col justify-center items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product15} />
<div className="flex items-center flex-col  space-y-3">
