...
import product21 from '/MyLandingPageProjects/ClothingStore/src/assets/WinterClothing/pngwing.com (14).png'
import product22 from '/MyLandingPageProjects/ClothingStore/src/assets/WinterClothing/pngegg (6).png'
import product23 from '/MyLandingPageProjects/ClothingStore/src/assets/WinterClothing/black_front_hoodie_mockup-Photoroom.png'



function WinterClothing() {
...
<div id="pr">
<Link  to='/product16' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
  <img width={200} src={product16} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product17' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
  <img width={200} src={product17} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product18' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
  <img width={200} src={product18} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product19' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product19} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product20' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product20} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product21' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product21} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product22' className="md:hidden flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product22} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product23' className="md:hidden flex flex-col justify-center items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product23} />
<div className="flex items-center flex-col  space-y-3">
...
<div id="pr" >
<Link  to='/product16' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
  <img width={200} src={product16} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product17' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
  <img width={200} src={product17} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product18' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
  <img width={200} src={product18} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product19' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product19} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product20' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product20} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product21' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product21} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product22' className="hidden md:flex flex-col items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product22} />
<div className="flex items-center  flex-col  space-y-3">
    ...
    <div id="pr">
<Link  to='/product23' className="hidden md:flex flex-col justify-center items-center bg-gray-800 rounded-2xl m-2">
<img width={200} src={product23} />
<div className="flex items-center flex-col  space-y-3">
